...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var Studentclasswise: Button
    ...
    private fun init() {
        ...
        Studentclasswise = findViewById<Button>(R.id.classwise).also {
            it.setOnClickListener { view ->
                val listStudent1 = mainViewModel.getStudentClassWise(this@MainActivity)
                studentListAdapter.updateList(listStudent1)
            }
        }
